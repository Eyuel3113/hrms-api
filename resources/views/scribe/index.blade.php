...
<div class="tocify-wrapper">
    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="analytics">
                    <a href="#analytics">Analytics</a>
                                    ...
                                    <ul id="tocify-subheader-analytics" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="analytics-GETapi-v1-analytics-daily-attendance">
                                <a href="#analytics-GETapi-v1-analytics-daily-attendance">Daily Attendance Summary</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="analytics-GETapi-v1-analytics-employees-by-department">
                                <a href="#analytics-GETapi-v1-analytics-employees-by-department">Employees by Department</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="analytics-GETapi-v1-analytics-kpi">
                                <a href="#analytics-GETapi-v1-analytics-kpi">Key Performance Indicators</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="analytics-GETapi-v1-analytics-payroll-outstanding">
                                <a href="#analytics-GETapi-v1-analytics-payroll-outstanding">Payroll Outstanding — Last 8 Months</a>
                            </li>
                                                                        </ul>
                            </ul>
                ...
                <li class="tocify-item level-1" data-unique="candidate-management">
                    <a href="#candidate-management">Candidate Management</a>
                                    ...
                                    <ul id="tocify-subheader-candidate-management" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="candidate-management-POSTapi-v1-candidates">
                                <a href="#candidate-management-POSTapi-v1-candidates">Submit Application</a>
                            </li>
                                ...
                                <a href="#candidate-management-PATCHapi-v1-recruitment-candidates--id--status">Update Status</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="candidate-management-GETapi-v1-recruitment-candidates--id--download-cv">
                                <a href="#candidate-management-GETapi-v1-recruitment-candidates--id--download-cv">Download Candidate CV</a>
                            </li>
                ...
                <li class="tocify-item level-1" data-unique="designations">
                    ...
                    <ul id="tocify-header-employee-social-links" class="tocify-header">
                <li class="tocify-item level-1" data-unique="employee-social-links">
                    <a href="#employee-social-links">Employee Social Links</a>
                </li>
                                    <ul id="tocify-subheader-employee-social-links" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="employee-social-links-GETapi-v1-employees--id--social-links">
                                <a href="#employee-social-links-GETapi-v1-employees--id--social-links">List Social Links</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="employee-social-links-POSTapi-v1-employees--id--social-links">
                                <a href="#employee-social-links-POSTapi-v1-employees--id--social-links">Add Social Link</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="employee-social-links-PATCHapi-v1-employees--id--social-links--linkId-">
                                <a href="#employee-social-links-PATCHapi-v1-employees--id--social-links--linkId-">Update Social Link</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="employee-social-links-DELETEapi-v1-employees--id--social-links--linkId-">
                                <a href="#employee-social-links-DELETEapi-v1-employees--id--social-links--linkId-">Delete Social Link</a>
                            </li>
                                                                        </ul>
                            </ul>
                ...
                <li class="tocify-item level-1" data-unique="employees">
                    <a href="#employees">Employees</a>
                                ...
                                <a href="#employees-PATCHapi-v1-employees--id--status">Toggle Status</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="employees-POSTapi-v1-employees--id--document">
                                <a href="#employees-POSTapi-v1-employees--id--document">Upload Document</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="employees-GETapi-v1-employees--id--document-download">
                                <a href="#employees-GETapi-v1-employees--id--document-download">Download Document</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="employees-DELETEapi-v1-employees--id--document">
                                <a href="#employees-DELETEapi-v1-employees--id--document">Delete Document</a>
                            </li>
                                                                        </ul>
                            </ul>
                ...
                <li class="tocify-item level-1" data-unique="job-management">
                    <a href="#job-management">Job Management</a>
                                    ...
                                    <ul id="tocify-subheader-job-management" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="job-management-GETapi-v1-jobs">
                                <a href="#job-management-GETapi-v1-jobs">List Active Jobs</a>
                            </li>
                ...
                <li class="tocify-item level-1" data-unique="payroll-management">
                    <a href="#payroll-management">Payroll Management</a>
                                ...
                                <a href="#payroll-management-GETapi-v1-payroll">List Payrolls</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="payroll-management-GETapi-v1-payroll-all">
                                <a href="#payroll-management-GETapi-v1-payroll-all">List All Payrolls (No Pagination)</a>
                            </li>
                ...
                <li class="tocify-item level-1" data-unique="settings">
                    <a href="#settings">Settings</a>
                                    ...
                                    <ul id="tocify-subheader-settings" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="settings-POSTapi-v1-settings-change-password">
                                <a href="#settings-POSTapi-v1-settings-change-password">Change Password</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="settings-POSTapi-v1-settings-change-email">
                                <a href="#settings-POSTapi-v1-settings-change-email">Change Email</a>
                            </li>
                                                                        </ul>
                            </ul>
...
<div class="bash-example">
    ...
    --get "http://localhost/api/v1/activity-logs?subject_type=architecto&amp;event=architecto" \
...
<i>optional</i> &nbsp;
 &nbsp;
    ...
    <br>
<p>Filter by subject type (e.g., Employee). Example: <code>architecto</code></p>
            </div>
                                    <div style="padding-left: 28px; clear: unset;">
...
<p>Filter by event type (created, updated, deleted). Example: <code>architecto</code></p>
                ...
                <h1 id="analytics">Analytics</h1>
                                ...
                                <h2 id="analytics-GETapi-v1-analytics-daily-attendance">Daily Attendance Summary</h2>

<p>
</p>

<p>Present, Half Day, Absent percentages for today.</p>

<span id="example-requests-GETapi-v1-analytics-daily-attendance">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/v1/analytics/daily-attendance" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost/api/v1/analytics/daily-attendance"
);
...
<span id="example-responses-GETapi-v1-analytics-daily-attendance">
            <blockquote>
...
<span id="execution-results-GETapi-v1-analytics-daily-attendance" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-v1-analytics-daily-attendance"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-v1-analytics-daily-attendance"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-v1-analytics-daily-attendance" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-v1-analytics-daily-attendance">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-v1-analytics-daily-attendance" data-method="GET"
      data-path="api/v1/analytics/daily-attendance"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-v1-analytics-daily-attendance', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-v1-analytics-daily-attendance"
                    onclick="tryItOut('GETapi-v1-analytics-daily-attendance');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-analytics-daily-attendance"
                    onclick="cancelTryOut('GETapi-v1-analytics-daily-attendance');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-v1-analytics-daily-attendance"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/v1/analytics/daily-attendance</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-v1-analytics-daily-attendance"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-v1-analytics-daily-attendance"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="analytics-GETapi-v1-analytics-employees-by-department">Employees by Department</h2>

<p>
</p>

<p>Percentage of employees in each department.</p>

<span id="example-requests-GETapi-v1-analytics-employees-by-department">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/v1/analytics/employees-by-department" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost/api/v1/analytics/employees-by-department"
);
...
<span id="example-responses-GETapi-v1-analytics-employees-by-department">
            <blockquote>
            <p>Example response (401):</p>
        </blockquote>
                <details class="annotation">
...
<span id="execution-results-GETapi-v1-analytics-employees-by-department" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-v1-analytics-employees-by-department"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-v1-analytics-employees-by-department"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-v1-analytics-employees-by-department" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-v1-analytics-employees-by-department">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-v1-analytics-employees-by-department" data-method="GET"
      data-path="api/v1/analytics/employees-by-department"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-v1-analytics-employees-by-department', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-v1-analytics-employees-by-department"
                    onclick="tryItOut('GETapi-v1-analytics-employees-by-department');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-analytics-employees-by-department"
                    onclick="cancelTryOut('GETapi-v1-analytics-employees-by-department');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-v1-analytics-employees-by-department"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/v1/analytics/employees-by-department</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-v1-analytics-employees-by-department"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-v1-analytics-employees-by-department"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="analytics-GETapi-v1-analytics-kpi">Key Performance Indicators</h2>

<p>
</p>

<p>Total employees, candidates, projects, today's present.</p>

<span id="example-requests-GETapi-v1-analytics-kpi">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/v1/analytics/kpi" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost/api/v1/analytics/kpi"
);
...
<span id="example-responses-GETapi-v1-analytics-kpi">
            <blockquote>
            <p>Example response (401):</p>
        </blockquote>
                <details class="annotation">
...
<span id="execution-results-GETapi-v1-analytics-kpi" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-v1-analytics-kpi"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-v1-analytics-kpi"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-v1-analytics-kpi" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-v1-analytics-kpi">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-v1-analytics-kpi" data-method="GET"
      data-path="api/v1/analytics/kpi"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-v1-analytics-kpi', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-v1-analytics-kpi"
                    onclick="tryItOut('GETapi-v1-analytics-kpi');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-analytics-kpi"
                    onclick="cancelTryOut('GETapi-v1-analytics-kpi');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-v1-analytics-kpi"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/v1/analytics/kpi</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-v1-analytics-kpi"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-v1-analytics-kpi"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="analytics-GETapi-v1-analytics-payroll-outstanding">Payroll Outstanding — Last 8 Months</h2>

<p>
</p>

<p>Total net salary per month for last 8 months.</p>

<span id="example-requests-GETapi-v1-analytics-payroll-outstanding">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/v1/analytics/payroll-outstanding" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost/api/v1/analytics/payroll-outstanding"
);
...
<span id="example-responses-GETapi-v1-analytics-payroll-outstanding">
            <blockquote>
            <p>Example response (401):</p>
        </blockquote>
                <details class="annotation">
...
<span id="execution-results-GETapi-v1-analytics-payroll-outstanding" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-v1-analytics-payroll-outstanding"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-v1-analytics-payroll-outstanding"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-v1-analytics-payroll-outstanding" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-v1-analytics-payroll-outstanding">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-v1-analytics-payroll-outstanding" data-method="GET"
      data-path="api/v1/analytics/payroll-outstanding"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-v1-analytics-payroll-outstanding', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-v1-analytics-payroll-outstanding"
                    onclick="tryItOut('GETapi-v1-analytics-payroll-outstanding');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-analytics-payroll-outstanding"
                    onclick="cancelTryOut('GETapi-v1-analytics-payroll-outstanding');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-v1-analytics-payroll-outstanding"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/v1/analytics/payroll-outstanding</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-v1-analytics-payroll-outstanding"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-v1-analytics-payroll-outstanding"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<form id="form-GETapi-v1-attendance--employeeId--attendance" data-method="GET"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('GETapi-v1-attendance--employeeId--attendance');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-attendance--employeeId--attendance"
                    onclick="cancelTryOut('GETapi-v1-attendance--employeeId--attendance');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<p>Example: <code>application/json</code></p>
    ...
    <p>APIs for managing candidates, applications, and hiring.</p>
                                ...
                                <h2 id="candidate-management-POSTapi-v1-candidates">Submit Application</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "http://localhost/api/v1/candidates" \
    ...
    --form "cv=@C:\Users\user\AppData\Local\Temp\phpF1A6.tmp" </code></pre></div>
...
<span id="execution-results-POSTapi-v1-candidates" hidden>
    ...
    <pre class="json"><code id="execution-response-content-POSTapi-v1-candidates"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-v1-candidates" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-v1-candidates">
...
<form id="form-POSTapi-v1-candidates" data-method="POST"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
            ...
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-v1-candidates"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-v1-candidates"
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-v1-candidates"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="job_id"                data-endpoint="POSTapi-v1-candidates"
               value="architecto"
               data-component="body">
    <br>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="full_name"                data-endpoint="POSTapi-v1-candidates"
               value="architecto"
               data-component="body">
    <br>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="email"                data-endpoint="POSTapi-v1-candidates"
               value="gbailey@example.net"
               data-component="body">
    <br>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="phone"                data-endpoint="POSTapi-v1-candidates"
               value="architecto"
               data-component="body">
    <br>
...
<small>file</small>&nbsp;
 ...
 &nbsp;
                <input type="file" style="display: none"
                              name="cv"                data-endpoint="POSTapi-v1-candidates"
               value=""
               data-component="body">
    <br>
<p>The CV/Resume file (pdf, doc, docx). Max 2MB. Example: <code>C:\Users\user\AppData\Local\Temp\phpF1A6.tmp</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="cover_letter"                data-endpoint="POSTapi-v1-candidates"
               value="architecto"
               data-component="body">
    <br>
...
<div class="bash-example">
    ...
    --form "phone=architecto"\
    --form "cover_letter=architecto"\
    --form "cv=@C:\Users\user\AppData\Local\Temp\phpF3A6.tmp" </code></pre></div>
...
<small>file</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>The CV/Resume file (pdf, doc, docx). Max 2MB. Example: <code>C:\Users\user\AppData\Local\Temp\phpF3A6.tmp</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>cover_letter</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
...
<p>The new status (new, reviewed, interview, shortlisted, rejected, hired). Example: <code>architecto</code></p>
                    ...
                    <h2 id="candidate-management-GETapi-v1-recruitment-candidates--id--download-cv">Download Candidate CV</h2>
...
<span id="example-requests-GETapi-v1-recruitment-candidates--id--download-cv">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/v1/recruitment/candidates/architecto/download-cv" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost/api/v1/recruitment/candidates/architecto/download-cv"
);
...
<span id="example-responses-GETapi-v1-recruitment-candidates--id--download-cv">
            <blockquote>
            <p>Example response (401):</p>
        </blockquote>
                <details class="annotation">
...
<span id="execution-results-GETapi-v1-recruitment-candidates--id--download-cv" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-v1-recruitment-candidates--id--download-cv"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-v1-recruitment-candidates--id--download-cv"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-v1-recruitment-candidates--id--download-cv" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-v1-recruitment-candidates--id--download-cv">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-v1-recruitment-candidates--id--download-cv" data-method="GET"
      data-path="api/v1/recruitment/candidates/{id}/download-cv"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-v1-recruitment-candidates--id--download-cv', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-v1-recruitment-candidates--id--download-cv"
                    onclick="tryItOut('GETapi-v1-recruitment-candidates--id--download-cv');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-recruitment-candidates--id--download-cv"
                    onclick="cancelTryOut('GETapi-v1-recruitment-candidates--id--download-cv');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-v1-recruitment-candidates--id--download-cv"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/v1/recruitment/candidates/{id}/download-cv</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-v1-recruitment-candidates--id--download-cv"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-v1-recruitment-candidates--id--download-cv"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="id"                data-endpoint="GETapi-v1-recruitment-candidates--id--download-cv"
               value="architecto"
               data-component="url">
    <br>
<p>The UUID of the candidate. Example: <code>architecto</code></p>
            </div>
                    </form>
...
<form id="form-GETapi-v1-departments-all" data-method="GET"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('GETapi-v1-departments-all');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-departments-all"
                    onclick="cancelTryOut('GETapi-v1-departments-all');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-PATCHapi-v1-departments--id--status" data-method="PATCH"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('PATCHapi-v1-departments--id--status');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-PATCHapi-v1-departments--id--status"
                    onclick="cancelTryOut('PATCHapi-v1-departments--id--status');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-GETapi-v1-designations" data-method="GET"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('GETapi-v1-designations');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-designations"
                    onclick="cancelTryOut('GETapi-v1-designations');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-POSTapi-v1-designations" data-method="POST"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('POSTapi-v1-designations');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-v1-designations"
                    onclick="cancelTryOut('POSTapi-v1-designations');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-GETapi-v1-designations--id-" data-method="GET"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('GETapi-v1-designations--id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-designations--id-"
                    onclick="cancelTryOut('GETapi-v1-designations--id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-PATCHapi-v1-designations--id-" data-method="PATCH"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('PATCHapi-v1-designations--id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-PATCHapi-v1-designations--id-"
                    onclick="cancelTryOut('PATCHapi-v1-designations--id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-PATCHapi-v1-designations--id--status" data-method="PATCH"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('PATCHapi-v1-designations--id--status');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-PATCHapi-v1-designations--id--status"
                    onclick="cancelTryOut('PATCHapi-v1-designations--id--status');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<p>The ID of the designation. Example: <code>architecto</code></p>
                ...
                <h1 id="employee-social-links">Employee Social Links</h1>

    <p>APIs for managing employee social media and professional links</p>

                                <h2 id="employee-social-links-GETapi-v1-employees--id--social-links">List Social Links</h2>

<p>
</p>

<p>Get all social links for an employee.</p>

<span id="example-requests-GETapi-v1-employees--id--social-links">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/v1/employees/architecto/social-links" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost/api/v1/employees/architecto/social-links"
);
...
<span id="example-responses-GETapi-v1-employees--id--social-links">
            <blockquote>
            <p>Example response (401):</p>
        </blockquote>
                <details class="annotation">
...
<span id="execution-results-GETapi-v1-employees--id--social-links" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-v1-employees--id--social-links"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-v1-employees--id--social-links"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-v1-employees--id--social-links" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-v1-employees--id--social-links">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-v1-employees--id--social-links" data-method="GET"
      data-path="api/v1/employees/{id}/social-links"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-v1-employees--id--social-links', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-v1-employees--id--social-links"
                    onclick="tryItOut('GETapi-v1-employees--id--social-links');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-employees--id--social-links"
                    onclick="cancelTryOut('GETapi-v1-employees--id--social-links');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-v1-employees--id--social-links"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/v1/employees/{id}/social-links</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-v1-employees--id--social-links"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-v1-employees--id--social-links"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="id"                data-endpoint="GETapi-v1-employees--id--social-links"
               value="architecto"
               data-component="url">
    <br>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="employeeId"                data-endpoint="GETapi-v1-employees--id--social-links"
               value="architecto"
               data-component="url">
    <br>
<p>Employee UUID Example: <code>architecto</code></p>
                    ...
                    <h2 id="employee-social-links-POSTapi-v1-employees--id--social-links">Add Social Link</h2>

<p>
</p>

<p>Add a new social link for an employee.</p>

<span id="example-requests-POSTapi-v1-employees--id--social-links">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-POSTapi-v1-employees--id--social-links">
</span>
<span id="execution-results-POSTapi-v1-employees--id--social-links" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-v1-employees--id--social-links"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-v1-employees--id--social-links"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-v1-employees--id--social-links" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-v1-employees--id--social-links">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-v1-employees--id--social-links" data-method="POST"
      data-path="api/v1/employees/{id}/social-links"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-v1-employees--id--social-links', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-v1-employees--id--social-links"
                    onclick="tryItOut('POSTapi-v1-employees--id--social-links');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-v1-employees--id--social-links"
                    onclick="cancelTryOut('POSTapi-v1-employees--id--social-links');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-v1-employees--id--social-links"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-v1-employees--id--social-links"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-v1-employees--id--social-links"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="id"                data-endpoint="POSTapi-v1-employees--id--social-links"
               value="architecto"
               data-component="url">
    <br>
<p>The ID of the employee. Example: <code>architecto</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="employeeId"                data-endpoint="POSTapi-v1-employees--id--social-links"
               value="architecto"
               data-component="url">
    <br>
<p>Employee UUID Example: <code>architecto</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="platform"                data-endpoint="POSTapi-v1-employees--id--social-links"
               value="architecto"
               data-component="body">
    <br>
<p>Platform ('linkedin', 'github', 'twitter', 'facebook', 'instagram', 'portfolio', 'telegram', 'slack', 'whatsapp', 'skype', 'behance', 'dribbble', 'other') Example: <code>architecto</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="url"                data-endpoint="POSTapi-v1-employees--id--social-links"
               value="http://www.bailey.biz/quos-velit-et-fugiat-sunt-nihil-accusantium-harum.html"
               data-component="body">
    <br>
<p>Full URL Example: <code>http://www.bailey.biz/quos-velit-et-fugiat-sunt-nihil-accusantium-harum.html</code></p>
        </div>
        </form>

                    <h2 id="employee-social-links-PATCHapi-v1-employees--id--social-links--linkId-">Update Social Link</h2>

<p>
</p>

<p>Update an existing social link.</p>

<span id="example-requests-PATCHapi-v1-employees--id--social-links--linkId-">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request PATCH \
    "http://localhost/api/v1/employees/architecto/social-links/architecto" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
    \"platform\": \"architecto\",
...
<span id="example-responses-PATCHapi-v1-employees--id--social-links--linkId-">
</span>
<span id="execution-results-PATCHapi-v1-employees--id--social-links--linkId-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-PATCHapi-v1-employees--id--social-links--linkId-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-PATCHapi-v1-employees--id--social-links--linkId-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-PATCHapi-v1-employees--id--social-links--linkId-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-PATCHapi-v1-employees--id--social-links--linkId-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-PATCHapi-v1-employees--id--social-links--linkId-" data-method="PATCH"
      data-path="api/v1/employees/{id}/social-links/{linkId}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('PATCHapi-v1-employees--id--social-links--linkId-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-PATCHapi-v1-employees--id--social-links--linkId-"
                    onclick="tryItOut('PATCHapi-v1-employees--id--social-links--linkId-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-PATCHapi-v1-employees--id--social-links--linkId-"
                    onclick="cancelTryOut('PATCHapi-v1-employees--id--social-links--linkId-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-PATCHapi-v1-employees--id--social-links--linkId-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-purple">PATCH</small>
            <b><code>api/v1/employees/{id}/social-links/{linkId}</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="PATCHapi-v1-employees--id--social-links--linkId-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="PATCHapi-v1-employees--id--social-links--linkId-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="id"                data-endpoint="PATCHapi-v1-employees--id--social-links--linkId-"
               value="architecto"
               data-component="url">
    <br>
<p>The ID of the employee. Example: <code>architecto</code></p>
                    ...
                    <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>linkId</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
 &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="linkId"                data-endpoint="PATCHapi-v1-employees--id--social-links--linkId-"
               value="architecto"
               data-component="url">
    <br>
<p>Social Link UUID Example: <code>architecto</code></p>
            </div>
                    <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>employeeId</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="employeeId"                data-endpoint="PATCHapi-v1-employees--id--social-links--linkId-"
               value="architecto"
               data-component="url">
    <br>
<p>Employee UUID Example: <code>architecto</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="platform"                data-endpoint="PATCHapi-v1-employees--id--social-links--linkId-"
               value="architecto"
               data-component="body">
    <br>
<p>Platform Example: <code>architecto</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>url</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="url"                data-endpoint="PATCHapi-v1-employees--id--social-links--linkId-"
               value="http://www.bailey.biz/quos-velit-et-fugiat-sunt-nihil-accusantium-harum.html"
               data-component="body">
    <br>
<p>URL Example: <code>http://www.bailey.biz/quos-velit-et-fugiat-sunt-nihil-accusantium-harum.html</code></p>
        </div>
        </form>

                    <h2 id="employee-social-links-DELETEapi-v1-employees--id--social-links--linkId-">Delete Social Link</h2>

<p>
</p>

<p>Delete a social link.</p>

<span id="example-requests-DELETEapi-v1-employees--id--social-links--linkId-">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-DELETEapi-v1-employees--id--social-links--linkId-">
</span>
<span id="execution-results-DELETEapi-v1-employees--id--social-links--linkId-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-DELETEapi-v1-employees--id--social-links--linkId-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-DELETEapi-v1-employees--id--social-links--linkId-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-DELETEapi-v1-employees--id--social-links--linkId-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-DELETEapi-v1-employees--id--social-links--linkId-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-DELETEapi-v1-employees--id--social-links--linkId-" data-method="DELETE"
      data-path="api/v1/employees/{id}/social-links/{linkId}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('DELETEapi-v1-employees--id--social-links--linkId-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-DELETEapi-v1-employees--id--social-links--linkId-"
                    onclick="tryItOut('DELETEapi-v1-employees--id--social-links--linkId-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-DELETEapi-v1-employees--id--social-links--linkId-"
                    onclick="cancelTryOut('DELETEapi-v1-employees--id--social-links--linkId-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-DELETEapi-v1-employees--id--social-links--linkId-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="DELETEapi-v1-employees--id--social-links--linkId-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="DELETEapi-v1-employees--id--social-links--linkId-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="id"                data-endpoint="DELETEapi-v1-employees--id--social-links--linkId-"
               value="architecto"
               data-component="url">
    <br>
<p>The ID of the employee. Example: <code>architecto</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="linkId"                data-endpoint="DELETEapi-v1-employees--id--social-links--linkId-"
               value="architecto"
               data-component="url">
    <br>
<p>Social Link UUID Example: <code>architecto</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="employeeId"                data-endpoint="DELETEapi-v1-employees--id--social-links--linkId-"
               value="architecto"
               data-component="url">
    <br>
<p>Employee UUID Example: <code>architecto</code></p>
...
<div class="bash-example">
    ...
    --form "photo=@C:\Users\user\AppData\Local\Temp\phpF235.tmp" </code></pre></div>
...
body.append('ending_date', '2052-01-23');
body.append('employment_type', 'freelance');
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Profile photo (image). Example: <code>C:\Users\user\AppData\Local\Temp\phpF235.tmp</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Must be a valid date. Must be a date after <code>joining_date</code>. Example: <code>2052-01-23</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
Must be one of:
<ul style="list-style-type: square;"><li><code>full-time</code></li> <li><code>part-time</code></li> <li><code>contract</code></li> <li><code>freelance</code></li> <li><code>intern</code></li></ul>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<form id="form-GETapi-v1-employees-all" data-method="GET"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('GETapi-v1-employees-all');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-employees-all"
                    onclick="cancelTryOut('GETapi-v1-employees-all');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<div class="bash-example">
    ...
    --form "date_of_birth=2025-12-30T15:54:00"\
    --form "gender=male"\
    ...
    --form "state=architecto"\
    --form "zip_code=architecto"\
    --form "joining_date=2025-12-30T15:54:00"\
    --form "ending_date=2052-01-23"\
    --form "employment_type=freelance"\
    ...
    --form "bank_account_number=architecto"\
    --form "tax_id=architecto"\
    --form "photo=@C:\Users\user\AppData\Local\Temp\phpF256.tmp" </code></pre></div>
...
body.append('date_of_birth', '2025-12-30T15:54:00');
...
body.append('state', 'architecto');
body.append('zip_code', 'architecto');
body.append('joining_date', '2025-12-30T15:54:00');
body.append('ending_date', '2052-01-23');
body.append('employment_type', 'freelance');
...
<form id="form-PATCHapi-v1-employees--id-" data-method="PATCH"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('PATCHapi-v1-employees--id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-PATCHapi-v1-employees--id-"
                    onclick="cancelTryOut('PATCHapi-v1-employees--id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Must be an image. Must not be greater than 5120 kilobytes. Example: <code>C:\Users\user\AppData\Local\Temp\phpF256.tmp</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>date_of_birth</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
 &nbsp;
               ...
               value="2025-12-30T15:54:00"
               data-component="body">
    <br>
<p>Must be a valid date. Example: <code>2025-12-30T15:54:00</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>gender</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
...
<div class="bash-example">
    ...
    --header "Content-Type: multipart/form-data" \
    --header "Accept: application/json" \
    --form "photo=@C:\Users\user\AppData\Local\Temp\phpF267.tmp" </code></pre></div>
...
<form id="form-POSTapi-v1-employees--id--photo" data-method="POST"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('POSTapi-v1-employees--id--photo');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-v1-employees--id--photo"
                    onclick="cancelTryOut('POSTapi-v1-employees--id--photo');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<small>file</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Image file (jpeg, png, jpg, max 5MB). Example: <code>C:\Users\user\AppData\Local\Temp\phpF267.tmp</code></p>
        </div>
        </form>
...
<form id="form-DELETEapi-v1-employees--id--photo" data-method="DELETE"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('DELETEapi-v1-employees--id--photo');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-DELETEapi-v1-employees--id--photo"
                    onclick="cancelTryOut('DELETEapi-v1-employees--id--photo');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-PATCHapi-v1-employees--id--status" data-method="PATCH"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('PATCHapi-v1-employees--id--status');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-PATCHapi-v1-employees--id--status"
                    onclick="cancelTryOut('PATCHapi-v1-employees--id--status');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<p>The ID of the employee. Example: <code>architecto</code></p>
                    ...
                    <h2 id="employees-POSTapi-v1-employees--id--document">Upload Document</h2>

<p>
</p>

<p>Upload or replace employee document (PDF only, max 2MB).</p>

<span id="example-requests-POSTapi-v1-employees--id--document">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "http://localhost/api/v1/employees/architecto/document" \
    --header "Content-Type: multipart/form-data" \
    --header "Accept: application/json" \
    --form "document=@C:\Users\user\AppData\Local\Temp\phpF27A.tmp" </code></pre></div>
...
<span id="example-responses-POSTapi-v1-employees--id--document">
</span>
<span id="execution-results-POSTapi-v1-employees--id--document" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-v1-employees--id--document"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-v1-employees--id--document"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-v1-employees--id--document" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-v1-employees--id--document">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-v1-employees--id--document" data-method="POST"
      data-path="api/v1/employees/{id}/document"
      data-authed="0"
      data-hasfiles="1"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-v1-employees--id--document', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-v1-employees--id--document"
                    onclick="tryItOut('POSTapi-v1-employees--id--document');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-v1-employees--id--document"
                    onclick="cancelTryOut('POSTapi-v1-employees--id--document');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-v1-employees--id--document"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-black">POST</small>
            <b><code>api/v1/employees/{id}/document</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-v1-employees--id--document"
               value="multipart/form-data"
               data-component="header">
    <br>
<p>Example: <code>multipart/form-data</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-v1-employees--id--document"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="id"                data-endpoint="POSTapi-v1-employees--id--document"
               value="architecto"
               data-component="url">
    <br>
<p>The ID of the employee. Example: <code>architecto</code></p>
...
<small>file</small>&nbsp;
 ...
 &nbsp;
                <input type="file" style="display: none"
                              name="document"                data-endpoint="POSTapi-v1-employees--id--document"
               value=""
               data-component="body">
    <br>
<p>PDF file (max 2MB). Example: <code>C:\Users\user\AppData\Local\Temp\phpF27A.tmp</code></p>
        </div>
        </form>

                    <h2 id="employees-GETapi-v1-employees--id--document-download">Download Document</h2>

<p>
</p>

<p>Download employee document.</p>

<span id="example-requests-GETapi-v1-employees--id--document-download">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/v1/employees/architecto/document/download" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost/api/v1/employees/architecto/document/download"
);
...
<span id="example-responses-GETapi-v1-employees--id--document-download">
            <blockquote>
            <p>Example response (401):</p>
        </blockquote>
                <details class="annotation">
...
<span id="execution-results-GETapi-v1-employees--id--document-download" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-v1-employees--id--document-download"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-v1-employees--id--document-download"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-v1-employees--id--document-download" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-v1-employees--id--document-download">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-v1-employees--id--document-download" data-method="GET"
      data-path="api/v1/employees/{id}/document/download"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-v1-employees--id--document-download', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-v1-employees--id--document-download"
                    onclick="tryItOut('GETapi-v1-employees--id--document-download');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-employees--id--document-download"
                    onclick="cancelTryOut('GETapi-v1-employees--id--document-download');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-v1-employees--id--document-download"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/v1/employees/{id}/document/download</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-v1-employees--id--document-download"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-v1-employees--id--document-download"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="id"                data-endpoint="GETapi-v1-employees--id--document-download"
               value="architecto"
               data-component="url">
    <br>
<p>The ID of the employee. Example: <code>architecto</code></p>
                    ...
                    <h2 id="employees-DELETEapi-v1-employees--id--document">Delete Document</h2>

<p>
</p>

<p>Delete employee document.</p>

<span id="example-requests-DELETEapi-v1-employees--id--document">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-DELETEapi-v1-employees--id--document">
</span>
<span id="execution-results-DELETEapi-v1-employees--id--document" hidden>
    <blockquote>Received response<span
                id="execution-response-status-DELETEapi-v1-employees--id--document"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-DELETEapi-v1-employees--id--document"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-DELETEapi-v1-employees--id--document" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-DELETEapi-v1-employees--id--document">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-DELETEapi-v1-employees--id--document" data-method="DELETE"
      data-path="api/v1/employees/{id}/document"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('DELETEapi-v1-employees--id--document', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-DELETEapi-v1-employees--id--document"
                    onclick="tryItOut('DELETEapi-v1-employees--id--document');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-DELETEapi-v1-employees--id--document"
                    onclick="cancelTryOut('DELETEapi-v1-employees--id--document');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-DELETEapi-v1-employees--id--document"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="DELETEapi-v1-employees--id--document"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="DELETEapi-v1-employees--id--document"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="id"                data-endpoint="DELETEapi-v1-employees--id--document"
               value="architecto"
               data-component="url">
    <br>
<p>The ID of the employee. Example: <code>architecto</code></p>
...
<p>Holiday UUID. Example: <code>architecto</code></p>
    ...
    <p>APIs for managing job postings, including creation, updates, and retrieval.</p>
                                ...
                                <h2 id="job-management-GETapi-v1-jobs">List Active Jobs</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/v1/jobs?search=Developer&amp;department_id=a1b2c3d4-e5f6-7890-g1h2-i3j4k5l6m7n8&amp;designation_id=b2c3d4e5-f6g7-8901-h2i3-j4k5l6m7n8o9&amp;limit=10&amp;page=2" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="search"                data-endpoint="GETapi-v1-jobs"
               value="Developer"
               data-component="query">
    <br>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="department_id"                data-endpoint="GETapi-v1-jobs"
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="designation_id"                data-endpoint="GETapi-v1-jobs"
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="limit"                data-endpoint="GETapi-v1-jobs"
               value="10"
               data-component="query">
    <br>
...
<form id="form-GETapi-v1-recruitment-jobs-inactive" data-method="GET"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('GETapi-v1-recruitment-jobs-inactive');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-recruitment-jobs-inactive"
                    onclick="cancelTryOut('GETapi-v1-recruitment-jobs-inactive');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-GETapi-v1-leaves" data-method="GET"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('GETapi-v1-leaves');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-leaves"
                    onclick="cancelTryOut('GETapi-v1-leaves');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-GETapi-v1-leaves--id-" data-method="GET"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('GETapi-v1-leaves--id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-leaves--id-"
                    onclick="cancelTryOut('GETapi-v1-leaves--id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-POSTapi-v1-leaves" data-method="POST"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('POSTapi-v1-leaves');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-v1-leaves"
                    onclick="cancelTryOut('POSTapi-v1-leaves');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-PATCHapi-v1-leaves--id--approve" data-method="PATCH"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('PATCHapi-v1-leaves--id--approve');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-PATCHapi-v1-leaves--id--approve"
                    onclick="cancelTryOut('PATCHapi-v1-leaves--id--approve');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-PATCHapi-v1-leaves--id--reject" data-method="PATCH"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('PATCHapi-v1-leaves--id--reject');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-PATCHapi-v1-leaves--id--reject"
                    onclick="cancelTryOut('PATCHapi-v1-leaves--id--reject');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-GETapi-v1-leaves--employeeId--leaves" data-method="GET"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('GETapi-v1-leaves--employeeId--leaves');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-leaves--employeeId--leaves"
                    onclick="cancelTryOut('GETapi-v1-leaves--employeeId--leaves');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-GETapi-v1-leave-types" data-method="GET"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('GETapi-v1-leave-types');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-leave-types"
                    onclick="cancelTryOut('GETapi-v1-leave-types');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-GETapi-v1-leave-types-active" data-method="GET"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('GETapi-v1-leave-types-active');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-leave-types-active"
                    onclick="cancelTryOut('GETapi-v1-leave-types-active');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-GETapi-v1-leave-types--id-" data-method="GET"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('GETapi-v1-leave-types--id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-leave-types--id-"
                    onclick="cancelTryOut('GETapi-v1-leave-types--id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-POSTapi-v1-leave-types" data-method="POST"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('POSTapi-v1-leave-types');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-v1-leave-types"
                    onclick="cancelTryOut('POSTapi-v1-leave-types');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-PATCHapi-v1-leave-types--id-" data-method="PATCH"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('PATCHapi-v1-leave-types--id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-PATCHapi-v1-leave-types--id-"
                    onclick="cancelTryOut('PATCHapi-v1-leave-types--id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-PATCHapi-v1-leave-types--id--status" data-method="PATCH"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('PATCHapi-v1-leave-types--id--status');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-PATCHapi-v1-leave-types--id--status"
                    onclick="cancelTryOut('PATCHapi-v1-leave-types--id--status');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-DELETEapi-v1-leave-types--id-" data-method="DELETE"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('DELETEapi-v1-leave-types--id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-DELETEapi-v1-leave-types--id-"
                    onclick="cancelTryOut('DELETEapi-v1-leave-types--id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-POSTapi-v1-payroll-generate" data-method="POST"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('POSTapi-v1-payroll-generate');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-v1-payroll-generate"
                    onclick="cancelTryOut('POSTapi-v1-payroll-generate');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-GETapi-v1-payroll" data-method="GET"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('GETapi-v1-payroll');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-payroll"
                    onclick="cancelTryOut('GETapi-v1-payroll');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<p>optional Default 10 Example: <code>16</code></p>
                    ...
                    <h2 id="payroll-management-GETapi-v1-payroll-all">List All Payrolls (No Pagination)</h2>
...
<span id="example-requests-GETapi-v1-payroll-all">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/v1/payroll/all?year=16&amp;month=16&amp;employee_id=architecto&amp;status=architecto" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost/api/v1/payroll/all"
);
...
<span id="example-responses-GETapi-v1-payroll-all">
            <blockquote>
            <p>Example response (401):</p>
        </blockquote>
                <details class="annotation">
...
<span id="execution-results-GETapi-v1-payroll-all" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-v1-payroll-all"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-v1-payroll-all"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-v1-payroll-all" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-v1-payroll-all">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-v1-payroll-all" data-method="GET"
      data-path="api/v1/payroll/all"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-v1-payroll-all', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-v1-payroll-all"
                    onclick="tryItOut('GETapi-v1-payroll-all');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-payroll-all"
                    onclick="cancelTryOut('GETapi-v1-payroll-all');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-v1-payroll-all"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/v1/payroll/all</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-v1-payroll-all"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-v1-payroll-all"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="year"                data-endpoint="GETapi-v1-payroll-all"
               value="16"
               data-component="query">
    <br>
<p>optional Example: <code>16</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="month"                data-endpoint="GETapi-v1-payroll-all"
               value="16"
               data-component="query">
    <br>
<p>optional Example: <code>16</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="employee_id"                data-endpoint="GETapi-v1-payroll-all"
               value="architecto"
               data-component="query">
    <br>
<p>optional Example: <code>architecto</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="status"                data-endpoint="GETapi-v1-payroll-all"
               value="architecto"
               data-component="query">
    <br>
<p>optional draft, locked, paid Example: <code>architecto</code></p>
...
<form id="form-GETapi-v1-payroll--id-" data-method="GET"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('GETapi-v1-payroll--id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-payroll--id-"
                    onclick="cancelTryOut('GETapi-v1-payroll--id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-PATCHapi-v1-payroll--id--lock" data-method="PATCH"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('PATCHapi-v1-payroll--id--lock');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-PATCHapi-v1-payroll--id--lock"
                    onclick="cancelTryOut('PATCHapi-v1-payroll--id--lock');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-PATCHapi-v1-payroll--id--paid" data-method="PATCH"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('PATCHapi-v1-payroll--id--paid');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-PATCHapi-v1-payroll--id--paid"
                    onclick="cancelTryOut('PATCHapi-v1-payroll--id--paid');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-GETapi-v1-projects-active" data-method="GET"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('GETapi-v1-projects-active');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-projects-active"
                    onclick="cancelTryOut('GETapi-v1-projects-active');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-GETapi-v1-projects-inactive" data-method="GET"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('GETapi-v1-projects-inactive');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-projects-inactive"
                    onclick="cancelTryOut('GETapi-v1-projects-inactive');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-PATCHapi-v1-projects--id--status" data-method="PATCH"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('PATCHapi-v1-projects--id--status');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-PATCHapi-v1-projects--id--status"
                    onclick="cancelTryOut('PATCHapi-v1-projects--id--status');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-POSTapi-v1-projects--id--assign" data-method="POST"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('POSTapi-v1-projects--id--assign');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-v1-projects--id--assign"
                    onclick="cancelTryOut('POSTapi-v1-projects--id--assign');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-PATCHapi-v1-projects--projectId--rate--employeeId-" data-method="PATCH"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('PATCHapi-v1-projects--projectId--rate--employeeId-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-PATCHapi-v1-projects--projectId--rate--employeeId-"
                    onclick="cancelTryOut('PATCHapi-v1-projects--projectId--rate--employeeId-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-GETapi-v1-projects-employee--employeeId--performance" data-method="GET"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('GETapi-v1-projects-employee--employeeId--performance');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-projects-employee--employeeId--performance"
                    onclick="cancelTryOut('GETapi-v1-projects-employee--employeeId--performance');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-GETapi-v1-projects-employees--employeeId-" data-method="GET"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('GETapi-v1-projects-employees--employeeId-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-projects-employees--employeeId-"
                    onclick="cancelTryOut('GETapi-v1-projects-employees--employeeId-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<p>optional Items per page. Default 10. Example: <code>20</code></p>
                ...
                <h1 id="settings">Settings</h1>
                                ...
                                <h2 id="settings-POSTapi-v1-settings-change-password">Change Password</h2>
...
<p>Must match new_password. Example: <code>architecto</code></p>
                    ...
                    <h2 id="settings-POSTapi-v1-settings-change-email">Change Email</h2>
...
<span id="example-requests-POSTapi-v1-settings-change-email">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "http://localhost/api/v1/settings/change-email" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
    \"current_password\": \"architecto\",
...
<span id="example-responses-POSTapi-v1-settings-change-email">
</span>
<span id="execution-results-POSTapi-v1-settings-change-email" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-v1-settings-change-email"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-v1-settings-change-email"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-v1-settings-change-email" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-v1-settings-change-email">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-v1-settings-change-email" data-method="POST"
      data-path="api/v1/settings/change-email"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-v1-settings-change-email', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-v1-settings-change-email"
                    onclick="tryItOut('POSTapi-v1-settings-change-email');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-v1-settings-change-email"
                    onclick="cancelTryOut('POSTapi-v1-settings-change-email');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-v1-settings-change-email"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-black">POST</small>
            <b><code>api/v1/settings/change-email</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-v1-settings-change-email"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-v1-settings-change-email"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="current_password"                data-endpoint="POSTapi-v1-settings-change-email"
               value="architecto"
               data-component="body">
    <br>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="new_email"                data-endpoint="POSTapi-v1-settings-change-email"
               value="gbailey@example.net"
               data-component="body">
    <br>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="new_email_confirmation"                data-endpoint="POSTapi-v1-settings-change-email"
               value="architecto"
               data-component="body">
    <br>
...
<p>Get all active shifts — perfect for dropdowns and attendance logic.</p>
...
<form id="form-GETapi-v1-shifts-active" data-method="GET"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('GETapi-v1-shifts-active');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-shifts-active"
                    onclick="cancelTryOut('GETapi-v1-shifts-active');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-PATCHapi-v1-shifts--id-" data-method="PATCH"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('PATCHapi-v1-shifts--id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-PATCHapi-v1-shifts--id-"
                    onclick="cancelTryOut('PATCHapi-v1-shifts--id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-PATCHapi-v1-shifts--id--status" data-method="PATCH"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('PATCHapi-v1-shifts--id--status');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-PATCHapi-v1-shifts--id--status"
                    onclick="cancelTryOut('PATCHapi-v1-shifts--id--status');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-GETapi-v1-trainings" data-method="GET"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('GETapi-v1-trainings');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-trainings"
                    onclick="cancelTryOut('GETapi-v1-trainings');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-POSTapi-v1-trainings" data-method="POST"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('POSTapi-v1-trainings');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-v1-trainings"
                    onclick="cancelTryOut('POSTapi-v1-trainings');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-GETapi-v1-trainings-active" data-method="GET"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('GETapi-v1-trainings-active');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-trainings-active"
                    onclick="cancelTryOut('GETapi-v1-trainings-active');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-GETapi-v1-trainings-inactive" data-method="GET"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('GETapi-v1-trainings-inactive');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-trainings-inactive"
                    onclick="cancelTryOut('GETapi-v1-trainings-inactive');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-GETapi-v1-trainings-employee--employeeId-" data-method="GET"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('GETapi-v1-trainings-employee--employeeId-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-trainings-employee--employeeId-"
                    onclick="cancelTryOut('GETapi-v1-trainings-employee--employeeId-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-GETapi-v1-trainings--id-" data-method="GET"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('GETapi-v1-trainings--id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-trainings--id-"
                    onclick="cancelTryOut('GETapi-v1-trainings--id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request PATCH \
    "http://localhost/api/v1/trainings/18daa315-6b5a-4a44-9663-3994d5c4b1b5" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
    \"title\": \"b\",
    \"description\": \"Eius et animi quos velit et.\",
    \"start_date\": \"2025-12-30T15:54:00\",
    \"end_date\": \"2052-01-23\",
    \"trainer_name\": \"n\",
    \"location\": \"g\",
    \"incentive_amount\": 12,
...
<form id="form-PATCHapi-v1-trainings--id-" data-method="PATCH"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('PATCHapi-v1-trainings--id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-PATCHapi-v1-trainings--id-"
                    onclick="cancelTryOut('PATCHapi-v1-trainings--id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               value="18daa315-6b5a-4a44-9663-3994d5c4b1b5"
               data-component="url">
    <br>
<p>The ID of the training. Example: <code>18daa315-6b5a-4a44-9663-3994d5c4b1b5</code></p>
            </div>
                            <h4 class="fancy-heading-panel"><b>Body Parameters</b></h4>
        <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>title</code></b>&nbsp;&nbsp;
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Must be a valid date. Must be a date after or equal to <code>start_date</code>. Example: <code>2052-01-23</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>trainer_name</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
...
<form id="form-PATCHapi-v1-trainings--id--status" data-method="PATCH"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('PATCHapi-v1-trainings--id--status');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-PATCHapi-v1-trainings--id--status"
                    onclick="cancelTryOut('PATCHapi-v1-trainings--id--status');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "http://localhost/api/v1/trainings/18daa315-6b5a-4a44-9663-3994d5c4b1b5/assign" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
    \"employee_ids\": [
...
<form id="form-POSTapi-v1-trainings--id--assign" data-method="POST"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('POSTapi-v1-trainings--id--assign');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-v1-trainings--id--assign"
                    onclick="cancelTryOut('POSTapi-v1-trainings--id--assign');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-POSTapi-v1-trainings--id--assign-all" data-method="POST"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('POSTapi-v1-trainings--id--assign-all');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-v1-trainings--id--assign-all"
                    onclick="cancelTryOut('POSTapi-v1-trainings--id--assign-all');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request PATCH \
    "http://localhost/api/v1/trainings/18daa315-6b5a-4a44-9663-3994d5c4b1b5/attend/architecto" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
    \"status\": \"architecto\",
...
<form id="form-PATCHapi-v1-trainings--trainingId--attend--employeeId-" data-method="PATCH"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('PATCHapi-v1-trainings--trainingId--attend--employeeId-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-PATCHapi-v1-trainings--trainingId--attend--employeeId-"
                    onclick="cancelTryOut('PATCHapi-v1-trainings--trainingId--attend--employeeId-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="url">
    <br>
<p>Example: <code>18daa315-6b5a-4a44-9663-3994d5c4b1b5</code></p>
            </div>
                    <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>employeeId</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
